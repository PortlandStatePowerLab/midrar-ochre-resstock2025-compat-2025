...
less_five_tons_df = (
    less_five_tons_df[less_five_tons_df["service"] == "cooling"]
).reset_index()
...
less_five_tons_df = (
    less_five_tons_df[["building_id", "timeseries_file"]].dropna(
        subset="timeseries_file"
    )
).reset_index()

x = less_five_tons_df["timeseries_file"].to_list()
